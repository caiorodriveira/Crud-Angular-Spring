...
public class Curso { // Mesmo nome da tabela então não precisa usar @Table
    ...
    @JsonProperty("_id") //Spring faz mapeamento pelo id declarado no angular
    private Long id;

    @Column(name = "nome",length = 200, nullable = false) //acocia a coluna com o nome dado ao atributo no banco de dados | tamanho de caracteres | not null
    private String nome;
